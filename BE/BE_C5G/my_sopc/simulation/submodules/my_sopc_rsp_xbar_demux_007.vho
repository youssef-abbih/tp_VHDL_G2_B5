...
--synthesis_resources = 
 ...
 ENTITY  my_sopc_rsp_xbar_demux_007 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END my_sopc_rsp_xbar_demux_007;

 ARCHITECTURE RTL OF my_sopc_rsp_xbar_demux_007 IS
