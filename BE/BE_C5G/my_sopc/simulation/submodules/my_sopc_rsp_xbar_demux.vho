...
--synthesis_resources = 
 ...
 ENTITY  my_sopc_rsp_xbar_demux IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END my_sopc_rsp_xbar_demux;

 ARCHITECTURE RTL OF my_sopc_rsp_xbar_demux IS
 ...
 END RTL; --my_sopc_rsp_xbar_demux
