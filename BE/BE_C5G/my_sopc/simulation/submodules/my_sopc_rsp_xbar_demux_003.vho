...
--synthesis_resources = 
 ...
 ENTITY  my_sopc_rsp_xbar_demux_003 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END my_sopc_rsp_xbar_demux_003;

 ARCHITECTURE RTL OF my_sopc_rsp_xbar_demux_003 IS
