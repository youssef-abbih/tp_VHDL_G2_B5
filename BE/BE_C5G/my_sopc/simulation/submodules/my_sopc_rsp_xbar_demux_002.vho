...
--synthesis_resources = 
 ...
 ENTITY  my_sopc_rsp_xbar_demux_002 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
		 ...
		 src0_data	:	OUT  STD_LOGIC_VECTOR (86 DOWNTO 0);
		 src0_endofpacket	:	OUT  STD_LOGIC;
		 src0_ready	:	IN  STD_LOGIC;
		 src0_startofpacket	:	OUT  STD_LOGIC;
		 src0_valid	:	OUT  STD_LOGIC
	 ); 
 END my_sopc_rsp_xbar_demux_002;

 ARCHITECTURE RTL OF my_sopc_rsp_xbar_demux_002 IS
 ...
 END RTL; --my_sopc_rsp_xbar_demux_002
