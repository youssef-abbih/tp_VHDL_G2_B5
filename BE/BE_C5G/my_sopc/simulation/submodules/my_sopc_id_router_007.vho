...
--synthesis_resources = 
 ...
 ENTITY  my_sopc_id_router_007 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END my_sopc_id_router_007;

 ARCHITECTURE RTL OF my_sopc_id_router_007 IS
 ...
 BEGIN
	...
	src_channel <= ( "0" & "0" & "0" & "0" & "0" & "0" & "0" & "0" & "1");
	src_data <= ( sink_data(90 DOWNTO 0));
	src_endofpacket <= sink_endofpacket;
	src_startofpacket <= sink_startofpacket;
	src_valid <= sink_valid;

 END RTL; --my_sopc_id_router_007
